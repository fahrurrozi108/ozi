    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="container">
          <h2>Detail Pengiriman Paket<hr></h2>
 
   <?php 
include '../../config.php';
$id =$_GET['id_pelanggan'];
$no = 1;
$data = mysqli_query($koneksi,"select * from tb_pelanggan where id_pelanggan='$id'");
while($d = mysqli_fetch_array($data)){
?>
<div>
<td><label for=""><b>ID   :</b></label>
<?php echo $no++; ?>
</td><br>
<td>
<label for="">Nama Pelanggan :</label>
<b><?php echo $d['nama_pelanggan']; ?></b>
   
</td><Br>
<div>
<label for="">Alamat Pengiriman :</label>
<b><?php echo $d['alamat']; ?></b>
</div>
<div>
<label for="">Kode Post :</label>
<b><?php echo $d['kode_post']; ?></b>
</div>
<div>
...
<div>
   <a href="print.php" target="blank" class="btn btn-warning">Cetak</a>
</div>
<?php 
}
?>
