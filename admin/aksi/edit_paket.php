...
?>
    <form action="p_edit_paket.php" method="POST">
    <div>
            <label for="">Id Paket</label>
            <input type="text"  class="form-control" name="id" value="<?php echo $d['id_paket']; ?>">
        </div>
        <div>
            <label for="">Nama Paket</label>
            <input type="text"  class="form-control" name="nama" value="<?php echo $d['nama_paket']; ?>">
        </div>
        <div>
            <label for="">Harga Satuan</label>
            <input type="text"  class="form-control" name="harga" value="<?php echo $d['harga_satuan'];?>">
        <div>
            <label for="">Ongkir</label>
            <input type="text"  class="form-control" name="ongkir"value="<?php echo $d['ongkir'];?>" >
        </div>
        <div><BR>
