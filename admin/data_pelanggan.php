...
<td><?php echo $d['kode_post']; ?></td>
<td><?php echo $d['no']; ?></td>
<td>
<a href="aksi/hapus_pelanggan.php?id_pelanggan=<?php echo $d['id_pelanggan']; ?>" class="btn btn-danger">Hapus</a>
<a href="aksi/detail_pelanggan.php?id_pelanggan=<?php echo $d['id_pelanggan']; ?>" class="btn btn-warning">Detail Pengiriman</a>
