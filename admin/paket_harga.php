...
<table class="table table-hover">
        ...
        <div>
            ...
            <TH>HARGA SATUAN</TH>
            <TH>ONGKIR</TH>
            <TH><a href="tambah.paket.php" class="btn btn-primary">Tambah</a></TH>
        </div>
        <?php 
    include '../config.php';
    $no = 1;
    ...
    <td>
    <a href="aksi/edit_paket.php?id_paket=<?php echo $d['id_paket']; ?>" class="btn btn-info">EDIT</a> ||
    <a href="aksi/hapus_paket.php?id_paket=<?php echo $d['id_paket']; ?>" class="btn btn-danger ">HAPUS</a>
    </td>
    </tr>
    <?php 
    }
